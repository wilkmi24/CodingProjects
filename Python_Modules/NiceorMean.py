...
#           return variables _means thatw e are returning the variable to 
...
def score(nice,mean,name):
    ...
    if nice > 2: # if conditions is valic, call win function passing in the variables so it can use them
        win(nice,mean,name)
