...
// This fuction adds the inputed task to the get_todos function array
function add() {
    ...
    function show() {
        // this sets the tassk that was retrieved as a variable
        var todos = get_todos();
    ...
    // This will keep the inputs displayed permantley on the screen
    show();

    //JSp387
    // This creates the functionality of removing a todo itme from the array
    function remove() {
