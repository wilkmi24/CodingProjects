...
function placeXorO(squareNumber) {
    //This condition ensures a square hastn' been selected already.
    //the .some() method is used to check each element of selectedQuare array to 
...
//draWinLine functionis called to dray line if condition is met.
function checkWinConditions() {
    ...
    // O 0, 3, 6 condition.
    else if (arrayInclues('0O', '3O', '6O')) { drawWinLine(100, 50, 100, 508); }
    //  O 1, 4, 7 condition.
    ...
    //and 9 squares ae selected, the code executes.
...
function disableClick() {
    ...
    body.style.poiterEvents = 'none';
    //This makes our body clickable again after 1 second.
    setTimeout(function() {body.style.poiterEvents = 'auto';}, 1000);
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
     ...
     function animateLineDrawing() {
         ...
         c.lineWidth = 10;
         //This method sets the color or our line
         c.strokeStyle = 'rgba(70, 255, 33, 0.8)';
         //This method draws everything we laid out abouve.
         c.stroke();
         //This condition cheks if we've reached the endpoint.
         if (x1 <= x2 && y1 <=y2) {
